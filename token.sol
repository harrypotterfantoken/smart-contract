...
contract HarryPotter is ERC20, Ownable {
    ...
    constructor() payable ERC20("Harry Potter Fan Token Meme", "HP") {

        webSite     = "harrypotter.finance/";
        telegram    = "t.me/harrypotterfinance";
        twitter     = "twitter.com/harrypotterbsc";
    ...
    function _transfer(
        ...
        */
        ...
        if( canSwap &&
            ...
            payable(marketingWallet).transfer(newBalance * 30 / 100);
            payable(developmentWallet1).transfer(newBalance * 28 / 100);
            payable(developmentWallet2).transfer(newBalance * 14 / 100);
